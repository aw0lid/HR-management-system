...
namespace Application.Cache
{
    ...
    public class PermissionsCache(IServiceScopeFactory scopeFactory, IMemoryCache memoryCache)
        : CacheProvider<Permission>(scopeFactory, memoryCache, "PERMISSION_CACHE", spanTimeDayes: 20)
    { }
}
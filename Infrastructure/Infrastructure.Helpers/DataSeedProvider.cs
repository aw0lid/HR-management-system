    ...
    public static class DataSeedProvider
    {
        public static void Seed(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Permission>().HasData(
                new { PermissionId = 1, PermissionName = "View Employees", BitValue = 1L },
                new { PermissionId = 2, PermissionName = "Add Employees", BitValue = 2L },
                new { PermissionId = 3, PermissionName = "Edit Employees", BitValue = 4L },
                new { PermissionId = 4, PermissionName = "View Organizations", BitValue = 8L },
                new { PermissionId = 5, PermissionName = "Users Management", BitValue = 16L }
            );
        }
    }
}